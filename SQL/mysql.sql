...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-06-2023 a las 17:31:13
...
INSERT INTO `votante` (`id`, `rut`, `nombre_completo`, `alias`, `email`, `region`, `comuna`) VALUES
(22, '19330183-5', 'Roberto Espinoza 2', 'Roerto1234', 'roberto.espinoza.espinoza@gmail.com', 4, 23);
...
ALTER TABLE `comunas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comuna_provincia` (`provincia_id`);
...
ALTER TABLE `provincias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `provincia_region` (`region_id`);
